...
//	//int* MIN = &MinIndex1;
//	//int* MAX = &MaxIndex1;
//	minMaxIdx(TotalSafeScore, &min, &idx, &MinIndex1, &MaxIndex1);
//	;
...
//	vector<int> TargetPos = { int(MinIndex) ,
...
//		Mat h = HessianMatrix.inv() * GradientMatrix;
//		//Dcount = 0;
...
//		//if (false) {
//		if (tmp < 0.41f && abs(tmp - ResultSafetyScore) < 0.001) {
//			//cout << "Final Pos: " << endl;
...
//		{
//			DeltaDXmi += gk_multiplier *lotaVector1.at<float>(0, i) * (PosDxm[i] - Dxm[i]) / deltaX.at<float>(0, i);
//		}
...
//		for (size_t i = 0; i < JointCount; i++)
//		{
//			DeltaDXmi += gk_multiplier * lotaVector2.at<float>(0, i) * (PosDxm[i] - Dxm[i]) / deltaX.at<float>(0, i);
//		}
...
//		for (size_t i = 0; i < JointCount; i++)
//		{
//			DeltaDXmi += gk_multiplier * lotaVector3.at<float>(0, i) * (PosDxm[i] - Dxm[i]) / deltaX.at<float>(0, i);
//		}
...
//	Mat Gradient_L1 = gk_multiplier * Get_gk(XmVector1, SVector1);
//	Mat Gradient_L2 = gk_multiplier * Get_gk(XmVector2, SVector2);
//	Mat Gradient_L3 = gk_multiplier * Get_gk(XmVector3, SVector3);
//	Mat Gradient_S1 = gk_multiplier * 2 * lotaVector1.mul(SVector1);
//	Mat Gradient_S2 = gk_multiplier * 2 * lotaVector2.mul(SVector2);
//	Mat Gradient_S3 = gk_multiplier * 2 * lotaVector3.mul(SVector3);
//
...
//					Dm_Xmi_Xmj += gk_multiplier*lotaVector1.at<float>(0, k) * ((Dm_p_ei[k] - 2 * Dm[k] + Dm_m_ei[k]) / pow(Delta, 2));
//				}
...
//				for (size_t k = 0; k < N; k++) {
//					Dm_Xmi_Xmj += gk_multiplier*lotaVector1.at<float>(0, k) * ((Dm_p_ei_ej[k] - Dm_p_ei[k] - Dm_p_ej[k] + Dm[k]) / pow(Delta, 2));
//				}
...
//
//				for (size_t k = 0; k < N; k++) {
//					Dm_Xmi_Xmj += gk_multiplier*lotaVector2.at<float>(0, k) * ((Dm_p_ei[k] - 2 * Dm[k] + Dm_m_ei[k]) / pow(Delta, 2));
//				}
...
//
//				for (size_t k = 0; k < N; k++) {
//					Dm_Xmi_Xmj += gk_multiplier*lotaVector2.at<float>(0, k) * ((Dm_p_ei_ej[k] - Dm_p_ei[k] - Dm_p_ej[k] + Dm[k]) / pow(Delta, 2));
//				}
...
//
//				for (size_t k = 0; k < N; k++) {
//					Dm_Xmi_Xmj += gk_multiplier*lotaVector3.at<float>(0, k) * ((Dm_p_ei[k] - 2 * Dm[k] + Dm_m_ei[k]) / pow(Delta, 2));
//				}
...
//
//				for (size_t k = 0; k < N; k++) {
//					Dm_Xmi_Xmj += gk_multiplier*lotaVector3.at<float>(0, k) * ((Dm_p_ei_ej[k] - Dm_p_ei[k] - Dm_p_ej[k] + Dm[k]) / pow(Delta, 2));
//				}
...
//		for (size_t j = 0; j < N; j++)
//		{
//			L_Xm_lota1.at<float>(i, j) = gk_multiplier*(Dm_p_ei[j] - Dm[j]) / Delta;//���l54
//		}
//	}
//	//X2
...
//		for (size_t j = 0; j < N; j++)
//		{
//			L_Xm_lota2.at<float>(i, j) = gk_multiplier*(Dm_p_ei[j] - Dm[j]) / Delta;//���l54
//		}
//	}
//	//X3
...
//		for (size_t j = 0; j < N; j++)
//		{
//			L_Xm_lota3.at<float>(i, j) = gk_multiplier*(Dm_p_ei[j] - Dm[j]) / Delta;//���l54
//		}
//	}
//
...
//	for (size_t i = 0; i < N; i++)
//	{
//		L_lota_S1.at<float>(i, i) = 2 * gk_multiplier* SVector1.at<float>(0, i);
//	}
//	Mat L_lota_S2 = Mat::zeros(N, N, CV_32F);
//	for (size_t i = 0; i < N; i++)
//	{
//		L_lota_S2.at<float>(i, i) = 2 * gk_multiplier * SVector2.at<float>(0, i);
//	}
//	Mat L_lota_S3 = Mat::zeros(N, N, CV_32F);
//	for (size_t i = 0; i < N; i++)
//	{
//		L_lota_S3.at<float>(i, i) = 2 * gk_multiplier * SVector3.at<float>(0, i);
//	}
//	Mat L_S1 = Mat::zeros(N, N, CV_32F);
//	for (size_t i = 0; i < N; i++)
//	{
//		L_S1.at<float>(i, i) = 2 * gk_multiplier * lotaVector1.at<float>(0, i);
//	}
//	Mat L_S2 = Mat::zeros(N, N, CV_32F);
//	for (size_t i = 0; i < N; i++)
//	{
//		L_S2.at<float>(i, i) = 2 * gk_multiplier * lotaVector2.at<float>(0, i);
//	}
//	Mat L_S3 = Mat::zeros(N, N, CV_32F);
//	for (size_t i = 0; i < N; i++)
//	{
//		L_S3.at<float>(i, i) = 2 * gk_multiplier * lotaVector3.at<float>(0, i);
//	}
//
